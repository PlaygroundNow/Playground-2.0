...
const pJS = function (tag_id, params) {
  var canvas_el = this.getRootNode().querySelector(
...
window.particlesJS = function (tag_id, params) {
  ...
  /* pJS elements */
  var pJS_tag = this.getRootNode().getElementById(tag_id),
  ...
  /* append canvas */
  var canvas = this.getRootNode().getElementById(tag_id).appendChild(canvas_el);

  /* launch particle.js */
  if (canvas != null) {
    pJSDom.push(pJS.call(this, tag_id, params));
  }
};
  ...
  xhr.onreadystatechange = function (data) {
    if (xhr.readyState == 4) {
      if (xhr.status == 200) {
        ...
        window.particlesJS.call(this, tag_id, params);
